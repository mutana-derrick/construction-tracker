...
<div class="max-w-3xl mx-auto">
    ...
    <!-- Form -->
    <form action="{{ route('equipment-costs.store') }}" method="POST" class="bg-white rounded-xl border border-gray-200 p-8">
        @csrf
        ...
        <div class="space-y-6 mb-8 pb-8 border-b border-gray-200">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input type="number" id="units_done" name="units_done" class="w-full px-4 py-2.5 border @error('units_done') border-red-500 @else border-gray-200 @enderror rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all" 
            ...
            <div>
                ...
                <input type="number" id="cost_per_unit" name="cost_per_unit" class="w-full px-4 py-2.5 border @error('cost_per_unit') border-red-500 @else border-gray-200 @enderror rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all" 
                    placeholder="0.00" step="0.01" min="0"
            ...
            <div>
                ...
                <div class="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 flex items-center font-bold text-lg text-green-600" id="total_cost_display">
                    $0.00
                </div>
            </div>
          </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="comment" name="comment" rows="4" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all" 
        ...
        <div class="flex items-center gap-4 pt-6">
            <button type="submit" class="inline-flex items-center gap-2 px-6 py-2.5 bg-primary-500 hover:bg-primary-600 text-white font-semibold rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                Create Cost Record
            </button>
            <a href="{{ route('equipment-costs.index', ['project_id' => $project->id]) }}" class="inline-flex items-center gap-2 px-6 py-2.5 border border-gray-300 hover:border-gray-400 text-gray-700 font-semibold rounded-lg transition-colors hover:bg-gray-50">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Tip Box -->
    <div class="mt-8 bg-linear-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-lg p-4 flex gap-3">
