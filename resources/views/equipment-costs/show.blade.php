...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        @if($canEdit)
        <a href="{{ route('equipment-costs.edit', $cost) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md">
            ✎ Edit Record
        </a>
        @endif
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <dl class="space-y-4">
            ...
            <div>
                ...
                <dd class="text-gray-900 mt-1 p-3 bg-gray-50 rounded border border-gray-200 shadow-sm">{{ $cost->comment }}</dd>
            </div>
            @else
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        @endif
        <a href="{{ route('equipment-costs.index', ['project_id' => $project->id]) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold rounded-lg transition-all duration-200">
            ← Back to Cost Records
        </a>
        <a href="{{ route('projects.show', $project) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold rounded-lg transition-all duration-200">
            ← Back to Project
        </a>
    </div>
</div>
