...
<div class="max-w-3xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <a href="{{ route('equipment-logs.index', ['project_id' => $project->id]) }}" class="inline-flex items-center gap-1 text-gray-600 hover:text-gray-900 font-medium transition-colors mb-3">
    ...
    <form action="{{ route('equipment-logs.store') }}" method="POST" class="bg-white rounded-xl border border-gray-200 p-8 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
            ...
            <a href="{{ route('equipment-logs.index', ['project_id' => $project->id]) }}" class="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold rounded-lg transition-all duration-200">
              Cancel
            </a>
        </div>
    </form>
    ...
    <div class="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p class="text-sm text-blue-900">
          ...
          <strong>Tip:</strong> Once created, this log can only be edited within 5 minutes. Plan carefully before submitting!
        </p>
    </div>
</div>
@endsection
